  ...
  return (
    <>
        <div className='w-full h-full inset-0 fixed bg-black bg-opacity-50 flex px-12 justify-center items-center'> 
            <div className=' w-[400px] h-[200px] bg-purple-200 text-black p-4 rounded-md relative'>
                ...
                <p className=" text-justify"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea minus a corrupti eveniet facilis, consequatur dolores officiis veniam laudantium repellendus. </p>
            </div>
        </div>      
    </>  
  )
